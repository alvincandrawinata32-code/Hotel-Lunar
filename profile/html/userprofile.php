...
.profile-card { background: linear-gradient(90deg, #4f95f5, #345e9e); color: white; border-radius: 6px; padding: 14px 18px; display: flex; align-items: center; gap: 14px; box-shadow: 0 2px 6px rgba(0,0,0,0.2); margin-bottom: 14px; }
.avatar { width: 44px; height: 44px; border-radius: 50%; background: #2f80ed; display: flex; align-items: center; justify-content: center; font-size: 24px; font-weight: bold; }
.profile-card h2 { font-size: 18px; font-weight: 700; }
.info-box { background: #f8f8f8; border-radius: 8px; padding: 20px 24px; margin-bottom: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.12); min-height: 90px; display: flex; flex-direction: column; justify-content: center; }
.label { font-size: 11px; color: #8b8b8b; margin-bottom: 8px; }
.info-box p { font-size: 18px; font-weight: 700; color: #111; }
